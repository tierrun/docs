export const navigation = [
  {
    ...
    links: [
      { title: 'Overview', href: '/docs', algoliaTitle: 'Overview' },
      {
        title: 'What is Tier?',
        href: '/docs/what-is-tier',
        algoliaTitle: 'Tier',
      },
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        algoliaTitle: 'Grandparenting',
      },
      {
        title: 'Entitlements & access',
        href: '/docs/features/entitlements-access',
        algoliaTitle: 'Entitlements',
      },
      {
        title: 'Metering',
        href: '/docs/features/metering',
        algoliaTitle: 'Metering',
      },
    ],
  },
  {
