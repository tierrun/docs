...
description: "This is an example application that shows using Tier to integrate pricing, in a way that makes it possible to implement best PriceOps practices with a trivial amount of effort. "
author: "issac"
category: "Demo"
published: true
---
...
connect`](/docs/cli/connect) command to give Tier
...
There's a lot more documentation available [on the Tier website](/docs). Try it out, and [let us know what you think](/join-slack)!
