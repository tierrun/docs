...
```jsx
await tier.schedule('org:customer-id-from-your-db',
	phases: [
		// Phase 1
		{
			features: [
				'feature:notes@plan:basic@2'
			],
			effective: new Date("Sun May 12, 2023"), // Optional: Provide effective data of subscription
			trial: false,
		},
		...
		{
			features: [
				'feature:api@plan:basic@2',
				'feature:golden-notes@plan:basic@2'
			],
...
You can find more details about these in our SDK references.
