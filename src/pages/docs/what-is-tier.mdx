---
description: "Tier gives you an opinionated way to implement pricing, limits the number of systems and data you have to deal with, works within your existing architecture/app, keeps you from having to do anything custom or one-off, provides a single place to handle anything related to pricing, billing, subscriptions, entitlements, metering, etc."
published: true
---
...
- [Recipes](/docs/recipes) - Examples of pricing model done using our Model builder and its `pricing.json`.
