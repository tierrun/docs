---
description: "Learn how to create a pricing table for your marketing page and also for use within your application for upselling plans to your customers."
published: true
---
