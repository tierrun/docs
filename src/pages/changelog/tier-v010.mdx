...
Tier models now support a Stripe’s division transform, which transforms the quantity _before_ multiplying the base price to determine the amount to bill. Stripe restricts transforms to metered+per_unit (see above for how to create these features).
...
![Pricing transforms](../images/changelog/tier-v010/pricing-transforms.png)
