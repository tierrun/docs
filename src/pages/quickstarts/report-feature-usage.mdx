...
4. [Registered customer](/quickstarts/register-customer)
5. [Entitlement checks enabled](/quickstarts/check-feature-access)
6. [Pricing Table](/quickstarts/render-pricing-table) (optional)
7. [Subscribed customers](/quickstarts/initiate-subscription) (optional)
...
```js
const access = await tier.can('org:customer-id-from-your-db', 'feature:feature-from-base-plan')
