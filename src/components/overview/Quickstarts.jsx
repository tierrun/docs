        ...
        <>
            <div className="grid grid-cols-1 pt-10 mt-4 border-t not-prose gap-x-6 gap-y-10 border-zinc-900/5 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
                ...
                <div className="flex flex-row items-start gap-6">
                    <div className="h-14 w-14">
                        <svg
                            ...
                            <path
                                ...
                                clipRule="evenodd"
                            />
                            <path fill="#798086" d="M32.2 7v12.6h12.6" />
                        </svg>
                    </div>
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Use our model builder to create your pricing plan,
                            with the right features & entitlements.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            As soon as a customer signs up for your product,
                            register them with Tier, we will sync it with
                            Stripe.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Hide or display features to your customer based on
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Create a pricing page for your marketing page and
                            also to upsell other plans.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Enable users to select a plan and create a stripe
                            checkout flow to make payment.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    <div className="h-14 w-14">
                        <svg
                            ...
                            <rect
                                ...
                                rx="4"
                            />
                            <circle cx="28" cy="28" r="18.667" fill="#4D5256" />
                            <path
                                fill="#798086"
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Wire up your app to report a feature usage by an
                            feature entitled customer.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Allow your customer to see all saved billing
                            details, feature usage and to change plans.
                        </p>
                        <p className="mt-4">
                            <Button
            ...
            <div className="flex flex-col mt-16">
                <p className="uppercase text-caption">
                    Learn from framework tutorials
                </p>
