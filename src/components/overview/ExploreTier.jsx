            ...
            <div className="grid grid-cols-1 pt-10 mt-4 border-t not-prose gap-x-6 gap-y-10 border-zinc-900/5 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Create a pricing model with our library of examples
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            A range of resources to implement pricing page,
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Utilities that automatically handle and manage
                            customers on your older pricing plan.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Simple functions to check usage, restrict access and
                            prompt upgrades.
                        </p>
                        <p className="mt-4">
                            <Button
                ...
                <div className="flex flex-row items-start gap-6">
                    ...
                    <div className="flex-auto">
                        ...
                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
                            Add capability to report usage of features in your
                            application and prompt actions.
                        </p>
                        <p className="mt-4">
                            <Button href="/features/metering" variant="text">
                                Read more
                            </Button>
                        </p>
                    </div>
